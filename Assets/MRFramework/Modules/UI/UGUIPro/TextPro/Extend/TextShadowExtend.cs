...
namespace MRFramework.UGUIPro
{
    ...
    public class TextShadowExtend
    {
        ...
        [SerializeField] private Color m_ShadowColorTopLeft = Color.white;
        [SerializeField] private Color m_ShadowColorTopRight = Color.white;
        [SerializeField] private Color m_ShadowColorBottomLeft = Color.white;
        [SerializeField] private Color m_ShadowColorBottomRight = Color.white;
        ...
        {
            get { return m_ShadowColorTopLeft; }
            set { m_ShadowColorTopLeft = value; }
        }

        public Color VertexTopRight
        {
            get { return m_ShadowColorTopRight; }
            set { m_ShadowColorTopRight = value; }
        }

        public Color VertexBottomLeft
        {
            get { return m_ShadowColorBottomLeft; }
            set { m_ShadowColorBottomLeft = value; }
        }

        public Color VertexBottomRight
        {
            get { return m_ShadowColorBottomRight; }
            set { m_ShadowColorBottomRight = value; }
        }
