...
namespace MRFramework.UGUIPro
{
    ...
    public class TextEffect : BaseMeshEffect
    {
        ...
        [SerializeField] [HideInInspector] private bool m_UseTextEffect;
        ...
        [SerializeField, UnityEngine.Range(0, 1)] [HideInInspector]
        private float m_Alpha = 1;

        [UnityEngine.Range(0.1f, 0.9f)] [SerializeField] [HideInInspector]
                ...
                if (base.graphic && base.graphic.material == base.graphic.defaultMaterial)
                {
                    Material material =
                        UnityEditor.AssetDatabase.LoadAssetAtPath<Material>(
                            "Assets/ZMUGUIPro/TextPro/Shaders/TextPro-Text.mat");
                    if (material == null)
