...
namespace MRFramework.UGUIPro
{
    ...
    public class VertexColorExtend
    {
        ...
        [SerializeField] private ColorFilterType m_VertexColorFilter = ColorFilterType.Additive;
        ...
        {
            get { return m_UseVertexColor; }

            set { m_UseVertexColor = value; }
        }


        public ColorFilterType VertexColorFilter
        {
            get { return m_VertexColorFilter; }

            set { m_VertexColorFilter = value; }
        }

        public Color VertexTopLeft
        {
            get { return m_VertexTopLeft; }

            set { m_VertexTopLeft = value; }
        }

        public Color VertexTopRight
        {
            get { return m_VertexTopRight; }

            set { m_VertexTopRight = value; }
        }

        public Color VertexBottomLeft
        {
            get { return m_VertexBottomLeft; }

            set { m_VertexBottomLeft = value; }
        }

        public Color VertexBottomRight
        {
            get { return m_VertexBottomRight; }

            set { m_VertexBottomRight = value; }
        }

        public Vector2 VertexColorOffset
        {
            get { return m_VertexColorOffset; }

            set { m_VertexColorOffset = value; }
        }
