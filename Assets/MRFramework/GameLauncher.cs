...
namespace MRFramework
{
    ...
    public class GameLauncher : MonoBehaviour
    {
        ...
        {
            // 切换到主页面场景
            SceneManager.Instance.LoadSceneAsync("Assets/AssetPackage/Scene/Common/Scene_Common_Main.unity", null, () =>
            {
        ...
        private void OnGameQuit()
        {
            ...
            GameArchitecture.Instance.OnDispose();
        }
    }
}