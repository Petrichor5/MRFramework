...
namespace MRFramework.UGUIPro
{
    public class ScrollViewProDrawEditor
    {
        ...
        [MenuItem("GameObject/UI/UGUI Pro/ScrollView Pro")]
        public static void CreateButtonPro()
        {
            var resources = GetStandardResources();
            
            GameObject root = CreateUIElementRoot("ScrollView Pro", new Vector2(200, 200), typeof(Image), typeof(ScrollViewPro));
