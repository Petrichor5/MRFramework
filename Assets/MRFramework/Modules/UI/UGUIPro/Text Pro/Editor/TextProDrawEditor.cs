...
namespace MRFramework.UGUIPro
{
    public static class TextProDrawEditor
    {
        ...
        {
            GameObject root = new GameObject("Text Pro", typeof(RectTransform), typeof(TextPro), typeof(LocalizeStringEvent), typeof(CanvasGroup));
        ...
        public static void TextSpacingGUI(string title, SerializedProperty m_UseTextSpacing,
            SerializedProperty m_TextSpacing, ref bool m_TextSpacingPanelOpen)
        {
            LayoutFrameBox(() =>
            {
        ...
        public static void VertexColorGUI(string title, SerializedProperty m_UseVertexColor,
            SerializedProperty m_VertexTopLeft, SerializedProperty m_VertexTopRight,
            SerializedProperty m_VertexBottomLeft, SerializedProperty m_VertexBottomRight,
            SerializedProperty m_VertexColorFilter, SerializedProperty m_VertexColorOffset,
            ref bool m_VertexColorPanelOpen)
        {
            LayoutFrameBox(() =>
            {
                ...
                if (m_UseVertexColor.boolValue)
                {
                    ...
                    Space();
                    m_VertexColorFilter.enumValueIndex =
                        (int)(VertexColorExtend.ColorFilterType)EditorGUILayout.EnumPopup(
                            new GUIContent("Filter"),
                            (VertexColorExtend.ColorFilterType)m_VertexColorFilter.enumValueIndex
                        );
        ...
        public static void TextShadowGUI(string title, SerializedProperty m_UseShadow,
            SerializedProperty m_ShadowColorTopLeft, SerializedProperty m_ShadowColorTopRight,
            SerializedProperty m_ShadowColorBottomLeft, SerializedProperty m_ShadowColorBottomRight,
            SerializedProperty m_ShadowEffectDistance, ref bool m_TextShadowPanelOpen)
        {
            LayoutFrameBox(() =>
            {
        ...
        public static void TextEffectGUI(string title, SerializedProperty m_UseTextEffect,
            ref bool m_TextEffectPanelOpen,
            ...
            LayoutFrameBox(() =>
            {
                ...
                if (m_UseTextEffect.boolValue)
                {
                    ...
                    if (m_EnableOutLine.boolValue)
                    {
                        ...
                        m_OpenShaderOutLine.boolValue =
                            EditorGUILayout.Toggle("Open Shader OutLine", m_OpenShaderOutLine.boolValue);
