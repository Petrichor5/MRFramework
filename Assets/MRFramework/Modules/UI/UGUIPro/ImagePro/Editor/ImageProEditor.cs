...
namespace MRFramework.UGUIPro
{
    ...
    {
        private string[] titles_E = { "裁剪遮罩" };
        private string[] titles_C = { "ImageMask" };
        ...
        void ImageProGUI()
        {
            ImageProDrawEditor.DrawImageMask(GetTitle(0), ref m_ImageMaskPanelOpen, m_IsUseMask, m_FillPercent, m_Fill,
