...
namespace MRFramework.UGUIPro
{
    ...
    public class ButtonProEditor : ButtonEditor
    {
        ...
        {
            ButtonProDrawEditor.DrawDoubleClickGUI("双击模式", ref m_DoubleClickPanelOpen, m_IsUseDoubleClick,
                m_ClickInterval, m_ButtonClickedEvent);

            ButtonProDrawEditor.DrawLongPressGUI("长按模式", ref m_LongPressPanelOpen, m_IsUseLongPress, m_Duration,
