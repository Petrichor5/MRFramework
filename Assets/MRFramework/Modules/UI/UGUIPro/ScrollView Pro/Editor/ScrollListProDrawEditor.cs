...
{
    public class ScrollListProDrawEditor
    {
        ...
        [MenuItem("GameObject/UI/UGUI Pro/ScrollList Pro (Horizontal)")]
        public static void CreateScrollListProHorizontal()
        {
            OnCreate(EScrollType.Horizontal);
        }

        [MenuItem("GameObject/UI/UGUI Pro/ScrollList Pro (Vertical)")]
        public static void CreateScrollListProVertical()
        {
            OnCreate(EScrollType.Vertical);
        }

        private static void OnCreate(EScrollType eScrollType)
        {
            var resources = GetStandardResources();

            GameObject root = CreateUIElementRoot("ScrollList Pro", new Vector2(200, 200), typeof(Image), typeof(ScrollListPro), typeof(CanvasGroup));
            ...
            ScrollListPro scrollRect = root.GetComponent<ScrollListPro>();
            scrollRect.ScrollType = eScrollType;
            ...
            scrollRect.horizontalScrollbarVisibility = ScrollListPro.ScrollbarVisibility.AutoHideAndExpandViewport;
            scrollRect.verticalScrollbarVisibility = ScrollListPro.ScrollbarVisibility.AutoHideAndExpandViewport;
