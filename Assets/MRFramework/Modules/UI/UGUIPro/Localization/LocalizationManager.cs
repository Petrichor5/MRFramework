...
namespace MRFramework.UGUIPro
{
    ...
    public class LocalizationManager : Singleton<LocalizationManager>
    {
        ...
        /// 已加载的本地多语言数据列表
        /// </summary>
        private Dictionary<LanguageType, List<LocalizationData>> m_LocalizationDataListDic =
            new Dictionary<LanguageType, List<LocalizationData>>();
        ...
        /// 本地多语言数据列表
        /// </summary>
        private List<LocalizationData> m_LocalizationDataList
        {
            get
            {
                return m_LocalizationDataListDic.ContainsKey(m_LanguageType)
                    ? m_LocalizationDataListDic[m_LanguageType]
                    : null;
            }
        }
        ...
        private void InitLanguageType()
        {
            ...
            LanguageType = int_language == 0
                ? LanguageType = LanguageType.English
                : LanguageType = (LanguageType)int_language;
        ...
        /// 预加载配置
        /// </summary>
        public async void PreLoadConfig()
        {
            if (m_LocalizationDataList != null)
                return;
        ...
        public LocalizationData GetLocalizationData(string key)
        {
            ...
            Log.Error(" key:" + key + " Can't find data!");
            return tempdata;
        }
